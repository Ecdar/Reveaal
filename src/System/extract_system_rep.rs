...
impl SystemRecipe {
    pub fn compile(self, dim: u32) -> Result<TransitionSystemPtr> {
        match self {
            ...
            SystemRecipe::Component(comp) => Ok(CompiledComponent::compile(*comp, dim + 1)?),
        }
    }
}
...
pub fn get_system_recipe(
    ...
    match side {
        ...
        QueryExpression::VarName(name) => {
            ...
            return Ok(Box::new(SystemRecipe::Component(Box::new(component))));
        }
