...
mod test {
    ...
    fn not_empty_result_test() {
        ...
        assert!(
            if let QueryResult::Refinement(RefinementResult::Failure(RefinementFailure::NotEmptyResult(_),)) = temp
                true
            else
                false
        );
    ...
    fn empty_transition2s_test() {
        ...
        assert!(
            if let QueryResult::Refinement(RefinementResult::Failure(RefinementFailure::EmptyTransition2s(_),)) = temp
                true
            else
                false
        );
    ...
    fn cuts_delay_solutions_test() {
        ...
        assert!(
            if let QueryResult::Refinement(RefinementResult::Failure(RefinementFailure::CutsDelaySolutions(_),)) = temp
                true
            else
                false
        );
    ...
    fn initial_state_test() {
        ...
        assert!(
            if let QueryResult::Refinement(RefinementResult::Failure(RefinementFailure::InitialState(_),)) = temp
                true
            else
                false
        );
    ...
    fn not_disjoint_and_not_subset_test() {
        ...
        assert!(
            if let QueryResult::Refinement(RefinementResult::Failure(RefinementFailure::NotDisjointAndNotSubset,)) = temp
                true
            else
                false
        );
    ...
    fn not_subset_test() {
        ...
        assert!(
            if let QueryResult::Refinement(RefinementResult::Failure(RefinementFailure::NotSubset,)) = temp
                true
            else
                false
        );
    ...
    fn not_disjoint_test() {
        ...
        assert!(
            if let QueryResult::Refinement(RefinementResult::Failure(RefinementFailure::NotDisjoint,)) = temp
                true
            else
                false
        );
