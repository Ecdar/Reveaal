...
mod composition_tests {
    ...
    #[test]
    fn Adm2SpecSavedRefinesSelf() {
        json_reconstructed_component_refines_base_self(ECDAR_UNI, "Adm2 || Spec");
    }

    #[test]
    fn AdministrationAdministrationSavedRefinesSelf() {
    ...
    #[test]
    fn AdministrationHalfAdm1SavedRefinesSelf() {
        json_reconstructed_component_refines_base_self(ECDAR_UNI, "Administration || HalfAdm1");
    }

    #[test]
    fn AdministrationHalfAdm2SavedRefinesSelf() {
    ...
    #[test]
    fn Machine3Machine3SavedRefinesSelf() {
